...
import { DollarSign, Percent, PieChart, Shield, Heart, Award, CheckCircle2, Clock } from "lucide-react";
...
export default function FinancialBreakdown({ project }: FinancialBreakdownProps) {
    ...
    const businessGrowth = totalValue * 0.10;
    const religiousAllocation = totalValue * 0.05;
    const netDistributable = totalValue - businessGrowth - religiousAllocation;

    const basePoolTotal = netDistributable * 0.20;
    const performancePoolTotal = netDistributable * 0.80;
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="glass-card p-6 bg-indigo-500/5 border-indigo-500/20">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-sm font-bold text-neutral-400 uppercase tracking-widest leading-none">Total Project Value</h3>
                    </div>
                    <div className="text-3xl font-bold text-white tracking-tight">₹{totalValue.toLocaleString()}</div>
                    <p className="text-xs text-neutral-500 mt-2">Gross budget allocated for this engagement</p>
                </div>
                ...
                <div className="glass-card p-6 bg-emerald-500/5 border-emerald-500/20">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-sm font-bold text-neutral-400 uppercase tracking-widest leading-none">Business Growth (10%)</h3>
                    </div>
                    <div className="text-3xl font-bold text-emerald-400 tracking-tight">₹{businessGrowth.toLocaleString()}</div>
                    <p className="text-xs text-neutral-500 mt-2">Reserved for technical infrastructure & scaling</p>
                </div>
                ...
                <div className="glass-card p-6 bg-rose-500/5 border-rose-500/20">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-sm font-bold text-neutral-400 uppercase tracking-widest leading-none">Religious Allocation (5%)</h3>
                    </div>
                    <div className="text-3xl font-bold text-rose-400 tracking-tight">₹{religiousAllocation.toLocaleString()}</div>
                    <p className="text-xs text-neutral-500 mt-2">Donated to community & charitable causes</p>
                </div>
            </div>
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-neutral-900/50">
                                ...
                                <th className="p-4 text-[10px] font-bold text-neutral-500 uppercase tracking-widest">Perf. Share</th>
                                <th className="p-4 text-[10px] font-bold text-neutral-500 uppercase tracking-widest text-right">Earning (Performance)</th>
                                <th className="p-4 text-[10px] font-bold text-neutral-500 uppercase tracking-widest text-right">Earning (Total Est.)</th>
                            </tr>
                        </thead>
                                    ...
                                    <tr key={c.partnerId} className="hover:bg-neutral-800/30 transition-colors">
                                        ...
                                        <td className="p-4 text-right">
                                            <div className="flex flex-col items-end">
                                                ...
                                                <span className="text-[10px] text-neutral-500 uppercase tracking-tighter">Incl. Base Share</span>
                                            </div>
                                        </td>
                                    </tr>
                                );
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="glass-card p-6 border-dashed border-indigo-500/20 bg-indigo-500/5 flex flex-col justify-between">
                    <div>
                        ...
                        <p className="text-xs text-neutral-500">Every partner has access to this data. Calculations are derived directly from task weights and project budget.</p>
                    </div>
