                            ...
                            {githubStats && (
                                <div className="glass-card overflow-hidden">
                                    <div className="p-6 border-b border-neutral-800 flex items-center justify-between bg-neutral-900/30">
                                        <div className="flex items-center gap-3">
                                            <div className="p-2.5 bg-neutral-800 rounded-xl border border-neutral-700/50">
                                                <Github className="w-5 h-5 text-white" />
                                            </div>
                                            <div>
                                                <h4 className="text-sm font-bold text-white">GitHub Repository Insights</h4>
                                                <p className="text-[10px] text-neutral-500 uppercase tracking-widest font-bold mt-0.5">Live Repository Analytics</p>
                                            </div>
                                        </div>
                                        <a
                                            ...
                                            className="px-4 py-2 bg-neutral-800 hover:bg-neutral-700 border border-neutral-700 rounded-xl text-xs font-bold text-white transition-all flex items-center gap-2 group"
                                        >
                                            View Source <ExternalLink className="w-3.5 h-3.5 text-neutral-400 group-hover:text-white transition-colors" />
                                        </a>
                                    </div>
                                    ...
                                    <div className="p-8">
                                        {githubStats.description && (
                                            <div className="mb-8">
                                                <h5 className="text-[10px] font-black text-neutral-500 uppercase tracking-[0.2em] mb-3">Repository Description</h5>
                                                <p className="text-sm text-neutral-300 leading-relaxed max-w-2xl">{githubStats.description}</p>
                                            </div>
                                        )}

                                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                                            <div className="p-4 bg-neutral-900/50 rounded-2xl border border-neutral-800/50 hover:border-indigo-500/30 transition-colors group">
                                                <div className="flex items-center gap-2 mb-3">
                                                    <Star className="w-4 h-4 text-amber-400" />
                                                    <span className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest">Stars</span>
                                                </div>
                                                <p className="text-2xl font-bold text-white">{githubStats.stars.toLocaleString()}</p>
                                            </div>
                                            <div className="p-4 bg-neutral-900/50 rounded-2xl border border-neutral-800/50 hover:border-indigo-500/30 transition-colors group">
                                                <div className="flex items-center gap-2 mb-3">
                                                    <GitFork className="w-4 h-4 text-indigo-400" />
                                                    <span className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest">Forks</span>
                                                </div>
                                                <p className="text-2xl font-bold text-white">{githubStats.forks.toLocaleString()}</p>
                                            </div>
                                            <div className="p-4 bg-neutral-900/50 rounded-2xl border border-neutral-800/50 hover:border-indigo-500/30 transition-colors group">
                                                <div className="flex items-center gap-2 mb-3">
                                                    <AlertCircle className="w-4 h-4 text-rose-400" />
                                                    <span className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest">Issues</span>
                                                </div>
                                                <p className="text-2xl font-bold text-white">{githubStats.issues.toLocaleString()}</p>
                                            </div>
                                            <div className="p-4 bg-neutral-900/50 rounded-2xl border border-neutral-800/50 hover:border-indigo-500/30 transition-colors group">
                                                <div className="flex items-center gap-2 mb-3">
                                                    <Eye className="w-4 h-4 text-emerald-400" />
                                                    <span className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest">Watchers</span>
                                                </div>
                                                <p className="text-2xl font-bold text-white">{githubStats.watchers.toLocaleString()}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 border-t border-neutral-800/50">
                                            <div className="space-y-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <p className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest">Primary Logic</p>
                                                        <p className="text-sm font-semibold text-white">{githubStats.language || 'Multi-language'}</p>
                                                    </div>
                                                </div>
                                                <div className="flex items-center gap-3">
                                                    <Scale className="w-4 h-4 text-neutral-500" />
                                                    <div>
                                                        <p className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest">License Type</p>
                                                        <p className="text-sm font-semibold text-white">{githubStats.license}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="space-y-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <p className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest">Last Activity</p>
                                                        <p className="text-sm font-semibold text-white">{new Date(githubStats.lastCommit).toLocaleDateString()}</p>
                                                    </div>
                                                </div>
                                                <div className="flex items-center gap-3">
                                                    <Calendar className="w-4 h-4 text-neutral-500" />
                                                    <div>
                                                        <p className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest">Created On</p>
                                                        <p className="text-sm font-semibold text-white">{new Date(githubStats.createdAt).toLocaleDateString()}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div>
                                                <h5 className="text-[10px] font-black text-neutral-500 uppercase tracking-[0.2em] mb-3">Repository Topics</h5>
                                                <div className="flex flex-wrap gap-2">
                                                    {githubStats.topics.length > 0 ? githubStats.topics.map((topic: string) => (
                                                        <span key={topic} className="px-2.5 py-1 bg-indigo-500/5 border border-indigo-500/10 rounded-lg text-[10px] font-bold text-indigo-400/80 uppercase">
                                                            {topic}
                                                        </span>
                                                    )) : (
                                                        <span className="text-xs text-neutral-600 italic">No topics defined</span>
                                                    )}
                                                </div>
                                            </div>
                                        </div>
