...
import { finalizeProject, logAdvancePayout, getAdvances, getPayouts, getProjectPredictions, updateAdvancePayout, deleteAdvancePayout } from '../controllers/payoutController.js';
const router = Router();
