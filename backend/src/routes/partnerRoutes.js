...
import { getPartners, getPartnerById, updatePartner, createPartner, deletePartner, getPartnerWorkload } from '../controllers/partnerController.js';
import { authenticate, authorize } from '../middleware/authMiddleware.js';
const router = Router();
router.get('/', authenticate, getPartners);
router.get('/workload', authenticate, getPartnerWorkload);
