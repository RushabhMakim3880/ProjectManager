...
export declare const getTasksByProject: (req: AuthRequest, res: Response, next: NextFunction) => Promise<void>;
...
export declare const getTaskStats: (req: AuthRequest, res: Response, next: NextFunction) => Promise<Response<any, Record<string, any>> | undefined>;
