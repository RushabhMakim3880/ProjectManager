    ...
    const projects = [
        {
            ...
            startDate: new Date(),
            status: 'ACTIVE',
            projectLeadId: (createdPartners[0]?.id || null), // John
            techLeadId: (createdPartners[2]?.id || null), // Mike
            commsLeadId: (createdPartners[1]?.id || null), // Jane
        },
        {
            ...
            startDate: new Date(),
            status: 'ACTIVE',
            projectLeadId: (createdPartners[0]?.id || null), // John (Overloading John)
            techLeadId: (createdPartners[0]?.id || null), // John
            commsLeadId: (createdPartners[1]?.id || null), // Jane
        },
        {
            ...
            startDate: new Date(),
            status: 'ACTIVE',
            projectLeadId: (createdPartners[2]?.id || null), // Mike
            techLeadId: (createdPartners[2]?.id || null), // Mike
        }
    ];
...
//# sourceMappingURL=seed_operations.js.map